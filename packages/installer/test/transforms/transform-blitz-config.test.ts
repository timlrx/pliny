...
import { customTsParser, transformConfig, TransformConfigCallback } from '@pliny/installer'
...
const executeTransform = (fileStr: string, transform: TransformConfigCallback) =>
  transformConfig(j(fileStr, { parser: customTsParser }), transform)

describe('transformConfig finds config', () => {
